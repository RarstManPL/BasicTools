...
public class AdminChatCommand extends Command {
    ...
    public AdminChatCommand(final Configuration.BasicCommand basicCommand) {
    ...
    public void onExecute(final CommandSender commandSender, final String[] args) {
        ...
        ChatUtil.broadCastPermissionMessage(this.permission + ".recive", this.messages.getMessage("AdminChatFormat"), "{message}", StringUtils.join(args, " "));
    }
}

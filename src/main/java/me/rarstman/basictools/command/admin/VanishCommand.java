...
public class VanishCommand extends Command {
    ...
    public VanishCommand(final Configuration.BasicCommand basicCommand) {
    ...
    public void onExecute(final CommandSender commandSender, final String[] args) {
        ...
        final String variableStatus = isVanished ? this.messages.getMessage("On") : this.messages.getMessage("Off");
        userCache1.setVanished(isVanished);
        this.userManager.toggleVanishStatus(player1, isVanished);
        ChatUtil.sendMessage(commandSender, this.messages.getMessage("VanishStatusChanged"),
        ...
        ChatUtil.sendMessage(player1, this.messages.getMessage("VanishStatusChangedInfo"), variableStatus);
    }
